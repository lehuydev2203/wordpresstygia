...
$Gio_cap_nhap=date(" h:i:s a");//lấy thời gian cập nhập
$ty_gia = $data->Exrate;//lấy data trong tag exrate
echo "<div  >";//định dạng margin-top là 25%
echo "<h1 style='color:white;text-align:center;font-size:60px'>Ngân hàng Vietcombank </h1><br>"; //tên ngân hàng
echo "
<div class='row'>
    <div class='col-12'>
        <div class='row'>
